...
import { BookMarked, ChevronLeft, ChevronRight, Moon, Sun } from "lucide-react";
...
export default function Home() {
  ...
  return (
    <div className="atlas-page">
      <div className={`atlas-layout ${isLeftRailHidden ? "is-left-rail-hidden" : ""}`}>
